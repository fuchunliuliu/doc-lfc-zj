...
static char uio_addr_buf[32]={0};
static char uio_size_buf[32]={0};
...
int main(void)
{
    ...
    uio_addr = (void*)strtoull(uio_addr_buf,NULL,0);
    uio_size = (uint64_t)strtoull(uio_size_buf,NULL,0);
    ...
    printf("The device address %p (lenth %lu)\n"
